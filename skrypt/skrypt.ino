// Piny
int speedsetter = 0; //pokrętło
const int button = 13; //guzik
const int analogPins[7] = {1, 2, 3, 4, 5, 6, 7}; //sensory patrząc z góry od lewej do prawej
// Motor lewy
const int ENL = 23;
const int L2 = 22;
...
//       float sensor_weights[7] = {0.0, -4.0, -3.0, -1.0, 0.0, 1.0, 3.0, 4.0, 0.0};
